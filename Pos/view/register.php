                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" action="" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label " for="avatar">Pilih Gambar</label>
                                        <div class="">
                                            <div class="custom-file">
                                                <input type="file" name="avatar" id="avatar" class="custom-file-input" id="site-logo">
                                    ...
                                    <div class="form-group">
                                        <div class="d-block">
                                            <label for="confirmasi" class="control-label">Confirmasi Password</label>
                                        </div>
                                        <input id="confirmasi" type="password" class="form-control" name="confirmasi" tabindex="2" required>
                                        <div class="invalid-feedback">
